...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-google-analytics/ rawdata/ bundle/analyze/datasets/tap-google-analytics/output || convert bundle/analyze/datasets/tap-google-analytics/ rawdata/ bundle/analyze/datasets/tap-google-analytics/output
